  ...
  return (
    <>
      <Card>
        ...
        <CardContent>
          {/* DNC Check Summary Banner */}
          {dncCheckRunning && (
            <div className="flex items-center gap-2 px-3 py-2 mb-3 rounded-md text-sm font-medium border bg-blue-50 border-blue-200 text-blue-700">
